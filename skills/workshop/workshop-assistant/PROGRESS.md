...
- [ ] **0. Setup** — repo cloned, deps installed, `server/.env` created, landed on `checkpoint-1-pre-grilling`, own working branch created.
- [ ] **1. Grill** — domain glossary written in `CONTEXT.md`; participant can state clearly what they're building and what they're not.
- [ ] **2. PRD** — product spec filed on the issue tracker.
- [ ] **3. Issues** — PRD sliced into small, independently-grabbable issues (vertical tracer-bullet slices).
- [ ] **4. Implementation** — build one issue at a time (TDD); the slice runs and its tests pass.
- [ ] **5. Test & review** — the diff matches the originating issue and follows the repo's standards.
- [ ] **6. Commit & push** — slice landed; loop back to phase 4 for the next issue until the PRD is satisfied.

## Artifacts (fill in as you go)

- CONTEXT.md written: **no**
- PRD issue: **—**
- Issues filed: **—**
